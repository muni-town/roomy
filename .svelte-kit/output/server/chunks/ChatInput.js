import { U as is_array, V as get_prototype_of, W as object_prototype, A as once, w as push, F as spread_props, y as pop, G as spread_attributes, E as bind_props, B as copy_payload, C as assign_payload, I as ensure_array_like, z as escape_html, x as setContext, T as getContext, J as fallback, X as slot, P as store_get, Q as unsubscribe_stores, Y as rest_props, Z as element, _ as sanitize_props, $ as store_set, a0 as invalid_default_snippet, K as attr, O as attr_class, M as attr_style } from "./index.js";
import "./client.js";
import { marked } from "marked";
import { isToday, format } from "date-fns";
import { decodeTime } from "ulidx";
import { g as getProfile, o as outerWidth } from "./profile.svelte.js";
import { m as mount, u as unmount, o as onDestroy, t as tick, I as Icon, h as html } from "./Icon.js";
...
import { H as Hidden_input, P as Popper_layer_force_mount, a as Popper_layer, k as getFloatingContentCSSVars, b as Floating_layer_anchor, F as Floating_layer, j as AvatarImage, A as Avatar, h as Avatar_image, i as Avatar_fallback, l as AvatarBeam } from "./Toaster.svelte_svelte_type_style_lang.js";
import { p as page } from "./index2.js";
import { C as Context, L as watch, E as ENTER, S as SPACE, w as getAriaChecked, M as getAriaRequired, h as getDataDisabled, l as useId, b as box, m as mergeProps, u as useRefById, g as getAriaExpanded, f as getDataOpenClosed, N as isElement$1, n as noop$2, O as useStateMachine, t as Presence_layer, p as useRovingFocus, q as getDataOrientation, i as getDisabled, B as Button, v as isAnnouncement } from "./button.js";
  ...
  const rootState = useCheckboxRoot(
    {
      ...
      indeterminate: box.with(() => indeterminate, (v2) => {
        indeterminate = v2;
        onIndeterminateChange?.(v2);
      }),
      type: box.with(() => type)
    },
    group
      ...
      return {
        onStart: (props) => {
          ...
          component = mount(SuggestionSelect, {
            ...
            props: {
              items: props.items,
              callback: ({ id, label }) => props.command({ id, label })
            }
          });
        },
        onUpdate: (props) => {
...
const e = null, { min: t, max: o, abs: n, floor: r } = Math, s = (e2, n2, r2) => t(r2, o(n2, e2)), c = (e2) => [...e2].sort((e3, t2) => e3 - t2), i = "function" == typeof queueMicrotask ? queueMicrotask : (e2) => {
...
}, m = "undefined" != typeof window, w = () => document.documentElement, g = (e2) => e2.ownerDocument, v = (e2) => e2.defaultView, b = /* @__PURE__ */ l(() => !!m && "rtl" === getComputedStyle(w()).direction), S = /* @__PURE__ */ l(() => /iP(hone|od|ad)/.test(navigator.userAgent)), I = /* @__PURE__ */ l(() => "scrollBehavior" in w().style), x = 1, _ = 4, T = 8, z = (e2) => o(e2.$getTotalSize(), e2.$getViewportSize()), R = (e2) => !!e2.$getViewportSize(), M = (r2, s2 = 40, i2 = 4, l2 = 0, m2, w2 = false) => {
  let g2 = !!l2, v2 = 1, b2 = 0, I2 = 0, y = 0, k = 0, x2 = 0, _2 = 0, T2 = 0, z2 = 0, R2 = g2 ? [0, o(l2 - 1, 0)] : e, M2 = [0, 0], J2 = 0;
  const P2 = ((e2, n2, r3) => ({ o: n2, t: a([], e2), l: e2, i: -1, u: a([], e2) }))(r2, s2), W2 = /* @__PURE__ */ new Set(), B2 = () => y - I2, L = () => B2() + x2 + k, O = (e2) => ((e3, o2, n2, r3) => {
  ...
  })(P2, e2, b2, M2[0]), q2 = () => ((e2) => e2.l ? $(e2, e2.l - 1) + u(e2, e2.l - 1) : 0)(P2), C2 = (e2) => $(P2, e2) - x2, U = (e2) => u(P2, e2), V = (e2) => {
    e2 && (S() && 0 !== T2 ? x2 += e2 : k += e2);
  };
  return { $getStateVersion: () => v2, $getCacheSnapshot: () => ((e2) => [e2.t.slice(), e2.o])(P2), $getRange: () => {
    let e2, n2;
    return _2 ? [e2, n2] = M2 : ([e2, n2] = M2 = O(o(0, L())), R2 && (e2 = t(e2, R2[0]), n2 = o(n2, R2[1]))), 1 !== T2 && (e2 -= o(0, i2)), 2 !== T2 && (n2 += o(0, i2)), [o(e2, 0), t(n2, P2.l - 1)];
  }, $findStartIndex: () => h(P2, L()), $findEndIndex: () => h(P2, L() + b2), $isUnmeasuredItem: (e2) => P2.t[e2] === f, $: () => !!R2 && P2.t.slice(o(0, R2[0] - 1), t(P2.l - 1, R2[1] + 1) + 1).includes(f), $getItemOffset: C2, $getItemSize: U, $getItemsLength: () => P2.l, $getScrollOffset: () => y, $isScrolling: () => 0 !== T2, $getViewportSize: () => b2, $getStartSpacerSize: () => I2, $getTotalSize: q2, h: () => (_2 = k, k = 0, [_2, 2 === z2 || B2() + b2 >= q2()]), $subscribe: (e2, t2) => {
    const o2 = [e2, t2];
    return W2.add(o2), () => {
      W2.delete(o2);
    };
    ...
    switch (t2) {
      case 1: {
        ...
        t3 && s4 < n(t3) + 1 || 0 !== z2 || (T2 = o2 < 0 ? 2 : 1), g2 && (R2 = e, g2 = false), y = r3, l3 = 4;
        const c2 = B2();
        c2 >= -b2 && c2 <= q2() && (l3 += 1, i3 = s4 > b2);
        break;
      }
      case 2:
      ...
      case 3: {
        ...
        if (!e2.length) break;
        V(e2.reduce((e3, [t3, o2]) => ((2 === z2 || (R2 ? !g2 && t3 < R2[0] : C2(t3) + (0 === T2 && 0 === z2 ? U(t3) : 0) < B2())) && (e3 += o2 - U(t3)), e3), 0));
    ...
    l3 && (v2 = 1 + (2147483647 & v2), s3 && x2 && (k += x2, x2 = 0), W2.forEach(([e2, t3]) => {
      l3 & e2 && t3(i3);
    }));
  } };
  ...
  let t2;
  return { S(o2) {
    (t2 || (t2 = new (v(g(o2))).ResizeObserver(e2))).observe(o2);
  }, I(e3) {
    t2.unobserve(e3);
  }, m() {
    t2 && t2.disconnect();
  ...
  let n2;
  const r2 = o2 ? "width" : "height", s2 = /* @__PURE__ */ new WeakMap(), c2 = q((o3) => {
    const c3 = [];
    for (const { target: i2, contentRect: l2 } of o3) if (i2.offsetParent) if (i2 === n2) t2.$update(4, l2[r2]);
    else {
      const t3 = s2.get(i2);
      t3 != e && c3.push([t3, l2[r2]]);
    }
    c3.length && t2.$update(3, c3);
  });
  return { $observeRoot(e2) {
    c2.S(n2 = e2);
  }, $observeItem: (e2, t3) => (s2.set(e2, t3), c2.S(e2), () => {
    s2.delete(e2), c2.I(e2);
  }), $dispose: c2.m };
};
...
function Virtualizer($$payload, $$props) {
  ...
  const resizer = C(store, horizontal);
...
export {
  ...
  Popover as P,
  ChatInput as a,
  Popover_trigger as b,
  Popover_content as c,
  getContentHtml as g
};
