import { A as once, w as push, G as spread_attributes, E as bind_props, y as pop, T as getContext, x as setContext, B as copy_payload, C as assign_payload, O as attr_class, z as escape_html, I as ensure_array_like, K as attr } from "../../../../../../chunks/index.js";
import "underscore";
...
import { y as SvelteMap, p as useRovingFocus, S as SPACE, E as ENTER, C as Context, q as getDataOrientation, z as getAriaOrientation, h as getDataDisabled, D as getAriaSelected, i as getDisabled, l as useId, n as noop, b as box, m as mergeProps, B as Button, o as Portal } from "../../../../../../chunks/button.js";
...
function timestamp($$payload, ulid2) {
  const decodedTime = decodeTime(ulid2);
...
function _page($$payload, $$props) {
  ...
  let relatedThreads = (() => {
    let related = {};
    if (space && channel) {
      Object.entries(space.view.threads).map(([ulid2, thread]) => {
        if (!thread.softDeleted && thread.relatedChannel === page.params.channel) {
          related[ulid2] = thread;
        }
      });
    }
    return related;
  ...
  function threadsTab($$payload2) {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let [ulid2, thread] = each_array[$$index];
      $$payload2.out += `<a${attr("href", `/space/${page.params.space}/thread/${ulid2}`)}><li class="list-row join-item flex items-center w-full bg-base-200"><h3 class="card-title text-xl font-medium text-primary">${escape_html(thread.title)}</h3> `;
      timestamp($$payload2, ulid2);
      $$payload2.out += `<!----></li></a>`;
    }
    $$payload2.out += `<!--]--></ul>`;
  }
