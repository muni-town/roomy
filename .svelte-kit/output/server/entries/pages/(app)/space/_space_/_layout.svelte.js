import { A as once, w as push, G as spread_attributes, E as bind_props, y as pop, x as setContext, B as copy_payload, C as assign_payload, O as attr_class, S as clsx, z as escape_html, I as ensure_array_like, K as attr } from "../../../../../chunks/index.js";
...
import { o as outerWidth, g as getProfile } from "../../../../../chunks/profile.svelte.js";
import { u as user } from "../../../../../chunks/user.svelte.js";
import { u as useRefById, S as SPACE, E as ENTER, C as Context, p as useRovingFocus, q as getDataOrientation, h as getDataDisabled, f as getDataOpenClosed, g as getAriaExpanded, s as getAriaDisabled, l as useId, n as noop, b as box, m as mergeProps, t as Presence_layer, B as Button, v as isAnnouncement } from "../../../../../chunks/button.js";
...
function _layout($$payload, $$props) {
  ...
  let isAdmin = space && user.agent && space.view.admins.includes(user.agent.assertDid);
  setContext("isAdmin", {
    get value() {
      return isAdmin;
    }
  ...
  let newCategoryName = "";
  let currentItemId = "";
  let showNewChannelDialog = false;
  let newChannelName = "";
  function openSpace() {
    if (space) return;
                ...
                Accordion_header($$payload4, {
                  ...
                  children: ($$payload5) => {
                    ...
                    if (isAdmin) {
                      $$payload5.out += "<!--[-->";
                      {
                        let dialogTrigger = function($$payload6) {
                          $$payload6.out += `<!---->`;
                          Button($$payload6, {
                            ...
                            children: ($$payload7) => {
                              Icon($$payload7, { icon: "lucide:settings", class: "size-4" });
                            },
                            $$slots: { default: true }
                          });
                          $$payload6.out += `<!---->`;
                        ...
                        Dialog_1($$payload5, {
                          ...
                          dialogTrigger,
                          children: ($$payload6) => {
                            $$payload6.out += `<form class="flex flex-col gap-4 w-full"><label class="input w-full"><span class="label">Name</span> <input${attr("value", categoryNameInput)} placeholder="channel-name"></label> <!---->`;
                            Button($$payload6, {
                              disabled: !categoryNameInput,
                              class: "btn btn-primary",
                              children: ($$payload7) => {
                                $$payload7.out += `<!---->Save Category`;
                              },
                              $$slots: { default: true }
                            });
                            $$payload6.out += `<!----></form>`;
  ...
  function $$render_inner($$payload2) {
    if (space) {
      ...
      if (isAdmin) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<menu class="menu p-0 w-full justify-between join join-vertical">`;
        {
          ...
          Dialog_1($$payload2, {
            title: "Create Channel",
            get isDialogOpen() {
              return showNewChannelDialog;
            },
            set isDialogOpen($$value) {
              showNewChannelDialog = $$value;
              $$settled = false;
            },
            dialogTrigger,
            children: ($$payload3) => {
              const each_array_3 = ensure_array_like(Object.keys(space.view.categories));
              $$payload3.out += `<form class="flex flex-col gap-4"><label class="input w-full"><span class="label">Name</span> <input${attr("value", newChannelName)} placeholder="General"></label> <label class="select w-full"><span class="label">Category</span> <select><option${attr("value", void 0)}>None</option><!--[-->`;
              for (let $$index = 0, $$length = each_array_3.length; $$index < $$length; $$index++) {
                let categoryId = each_array_3[$$index];
        ...
        $$payload2.out += `<!----> `;
        {
          ...
          Dialog_1($$payload2, {
            title: "Create Category",
            get isDialogOpen() {
              return showNewCategoryDialog;
            },
            set isDialogOpen($$value) {
              showNewCategoryDialog = $$value;
              $$settled = false;
            },
            dialogTrigger,
            children: ($$payload3) => {
              $$payload3.out += `<form class="flex flex-col gap-4"><label class="input w-full"><span class="label">Name</span> <input${attr("value", newCategoryName)} placeholder="Discussions"></label> <!---->`;
              Button($$payload3, {
                class: "btn btn-primary",
                children: ($$payload4) => {
                  Icon($$payload4, {
