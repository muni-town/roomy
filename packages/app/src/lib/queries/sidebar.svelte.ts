    ...
    return sql`-- sidebar (recursive CTE)
      with recursive room_tree as (
        ...
        select
          ...
          (select max(id) from entities where room = e.id) as latestEntity,
        ...
        from entities e
          ...
          join comp_info i on e.id = i.entity
          left join comp_last_read l on e.id = l.entity
          left join comp_room parent_room on parent_room.entity = e.room
        where e.stream_id = ${spaceId}
        ...
        from entities e
          ...
          join comp_info i on e.id = i.entity
          left join comp_last_read l on e.id = l.entity
          join entities parent_e on parent_e.id = e.room
        ...
        from entities e
          ...
          join comp_info i on e.id = i.entity
          left join comp_last_read l on e.id = l.entity
          join room_tree rt on e.room = rt.id
