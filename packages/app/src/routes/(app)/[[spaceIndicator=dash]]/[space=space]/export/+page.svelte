<script lang="ts">
  ...
  import { Announcement, Message, Image, Category, TimelineItem } from "@roomy-chat/sdk";
  ...
  async function export_timeline(timeline: TimelineItem[], channelId: string, guildId: string) {
    const messages = [];
...
<button onclick={export_space}>Export</button>
