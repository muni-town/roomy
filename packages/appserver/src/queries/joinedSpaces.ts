...
/**
 * Return the caller's joined-and-not-removed spaces.
 *
 ...
 * stream's own `member`/`admin` edges carry the actual membership truth, and
 * a space is only returned when both agree (and the caller isn't banned).
 */
